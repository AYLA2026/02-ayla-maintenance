...
const cards = [
  {
    title: "تقرير النظافة",
    desc: "استيراد Excel + صور + فلترة ذكية",
    href: "/reports/cleaning",
    icon: Sparkles,
  ...
  {
    title: "التقرير المصور PPT",
    desc: "رفع صور → فلترة → تصدير PowerPoint",
    href: "/reports/ppt",
    icon: Camera,
  ...
  {
    title: "بلاغات مغلقة",
    desc: "تقارير البلاغات المنجزة من الفنيين",
    href: "/reports/closed-complaints",
    icon: CheckCircle,
