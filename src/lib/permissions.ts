...
export const ROLE_COLORS: Record<UserRole, string> = {
  ...
  admin: "text-[#C9A227] bg-[#C9A227]/10 border-[#C9A227]/20",
  supervisor: "text-blue-600 bg-blue-50 border-blue-200",
  technician: "text-green-600 bg-green-50 border-green-200",
...
export const PERMISSIONS: Record<string, UserRole[]> = {
  ...
  complaints_auto: ["super_admin", "admin"],
